...
pui.layout.template.responsiveLayoutTemplate = function(parms) {  
  ...
  if (returnProps) {
    ...
    return pui.layout.mergeProps([
      { name: "layout items", help: "The number of containers for this layout.", choices: ['1','2','3','4','5','6','Other...'] },
      { name: "style rules", type: "responsive", 
        help: "String of CSS stylesheet rules, used to define positions and dimensions of containers. Leave empty when styles are expected to be defined"
          +" in an external stylesheet. See the <a target=\"_blank\" href=\"http://www.profoundlogic.com/docs/display/PUI/Responsive+Layout\">Responsive Layout</a>"},
      { name: "use viewport", help: "Determines how @media rules in &quot;style rules&quot; are interpreted. When &quot;use viewport&quot; is true, "
      +"the page size determines which @media rules to apply. When false, the layout's height and width determine which @media rules to apply. Defaults to true. <br><br>See "+
      "<a href=\"http://www.profoundlogic.com/docs/display/PUI/Responsive+Layout\" target=\"_blank\">Responsive Layout</a>.", choices: ["true", "false"]}
    ]);
  }
